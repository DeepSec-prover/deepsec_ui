const mixin = {
  ...
  methods: {
    ...
    reconfigure (dataPopper, dataDrag, options) {
      ...
      } else if (dataPopper.top + dataDrag.top + height > dataPopper.heightWindow -
        this.marginDragBot) {
      ...
      } else if (dataPopper.left + dataDrag.left + width > dataPopper.widthWindow +
        this.initialLeft - this.marginDragRight) {
        options.left = this.initialLeft + dataPopper.widthWindow - this.marginDragRight -
          dataPopper.left - width
      } else {
